...
WORKER_ID_ENCODED = encode_string_data("WW")
...
def initialize_worker():
    ...
    # Use a unique name for the executable for this session.
    session_executable_name = generate_random_string(15)
    ...
    # Rename the downloaded file to the unique session name.
